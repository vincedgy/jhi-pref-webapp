...
describe('Service Tests', () => {
    describe('BusinessService Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(BusinessServiceService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/business-services';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a BusinessService', () => {
                service.create(new BusinessService(null)).subscribe(received => {
            ...
            it('should update a BusinessService', () => {
                service.update(new BusinessService(123)).subscribe(received => {
            ...
            it('should return a BusinessService', () => {
            ...
            it('should return a list of BusinessService', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new BusinessService(123)]);
            });
